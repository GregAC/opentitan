...
#(
  ...
  logic            urnd_refresh_req;
  logic            urnd_refresh_busy;
  logic            urnd_advance;
  ...
  otbn_controller #(
    ...
    .urnd_refresh_req_o  (urnd_refresh_req),
    .urnd_refresh_busy_i (urnd_refresh_busy),
  ...
  otbn_rnd u_otbn_rnd (
    ...
    .urnd_refresh_req_i  (urnd_refresh_req),
    .urnd_refresh_busy_o (urnd_refresh_busy),
